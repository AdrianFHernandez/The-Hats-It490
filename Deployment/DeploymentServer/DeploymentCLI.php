...
function menu()
{
    ...
    echo "\n--- Deployment Menu ---\n";
    echo "1. Deploy bundle to machine\n";
    echo "2. Rollback bundle\n";
    echo "3. List all bundles\n";
    echo "4. List versions for a bundle\n";
...
while (true) {
    ...
    switch ($choice) {
        case "1":
            ...
            $version = prompt("Enter version number");
            ...
            $env = strtolower($env);
            $res = deployBundle($env, $bundleName, $version);
            showResponse($res);
            break;
        ...
        case "5":
            ...
            $res = markStatusInDeployment($bundleName, $version, $status);
            showResponse($res);
            break;
        case "6":
            echo "Exiting...\n";
